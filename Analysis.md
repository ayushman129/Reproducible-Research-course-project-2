...
Github repo for the Course Project: [Reproducible Research](https://github.com/ayushman129/Reproducible-Research-course-project-2)
...
download.file(fileUrl, destfile = paste0("C:/Users/Asus/Documents/Reproducible research/Reproducible-Research-course-project-2", '/repdata%2Fdata%2FStormData.csv.bz2'))
```

    ## Warning in download.file(fileUrl, destfile = paste0("C:/Users/Asus/Documents/Reproducible research/Reproducible-Research-course-project-2", :
    ## downloaded length 44180209 != reported length 49177144

    ## Warning in download.file(fileUrl, destfile = paste0("C:/Users/Asus/Documents/Reproducible research/Reproducible-Research-course-project-2", :
    ## URL 'https://d396qusza40orc.cloudfront.net/repdata%2Fdata%2FStormData.csv.bz2': Timeout of 60 seconds was reached

    ## Error in download.file(fileUrl, destfile = paste0("C:/Users/Asus/Documents/Reproducible research/Reproducible-Research-course-project-2", : download from 'https://d396qusza40orc.cloudfront.net/repdata%2Fdata%2FStormData.csv.bz2' failed

``` r
stormDF <- read.csv("C:/Users/Asus/Documents/Reproducible research/Reproducible-Research-course-project-2/repdata%2Fdata%2FStormData.csv.bz2")
```
...
```
    ...
    ## 1:             FLOOD 137002415857 5507096450 142509512307
    ## 2: HURRICANE/TYPHOON  69305840000 2607872800  71913712800
    ## 3:           TORNADO  47158022977  385592270  47543615247
    ## 4:       STORM SURGE  43323536000       5000  43323541000
    ## 5:              HAIL  15285043213 2943620473  18228663686
...
```
    ...
    ## 1:        TORNADO       5047    85195  90242
    ## 2: EXCESSIVE HEAT       1867     6387   8254
    ## 3:    FLASH FLOOD        915     1747   2662
    ## 4:           HEAT        874     1489   2363
    ## 5:      LIGHTNING        790     5038   5828
...
```
    ...
    ## 1:        TORNADO FATALITIES  5047
    ## 2: EXCESSIVE HEAT FATALITIES  1867
    ## 3:    FLASH FLOOD FATALITIES   915
    ## 4:           HEAT FATALITIES   874
    ## 5:      LIGHTNING FATALITIES   790
...
![plot of chunk healthChart](figure/healthChart-1.png)
...
```
    ...
    ## 1:             FLOOD    propCost 137002415857
    ## 2: HURRICANE/TYPHOON    propCost  69305840000
    ## 3:           TORNADO    propCost  47158022977
    ## 4:       STORM SURGE    propCost  43323536000
    ## 5:              HAIL    propCost  15285043213
...
![plot of chunk econChart](figure/econChart-1.png)
